    ...
    <div className="h-[calc(100vh-4rem)] flex flex-col p-6 max-w-4xl mx-auto">
      <div className="glass-panel rounded-xl flex-1 flex flex-col overflow-hidden border border-white/10">
        ...
        <div className="p-4 border-b border-white/10 bg-slate-900/50 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-white font-display">AQI Zero Intelligence</h2>
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-950/30" ref={scrollRef}>
          {messages?.map((msg) => (
            <motion.div
              key={msg.id}
